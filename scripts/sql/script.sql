...
-- PROFILES
-----------------------------------
INSERT INTO KF2DATABASE.PROFILES(ID, NAME, ID_LANGUAGE, ID_GAMETYPE, ID_MAP, ID_DIFFICULTY, ID_LENGTH, ID_MAXPLAYERS, SERVER_NAME, WEB_PORT, GAME_PORT, QUERY_PORT, WEB_PAGE, TAKEOVER, CHEAT_PROTECTION, TEAM_COLLISION, ADMIN_CAN_PAUSE, ANNOUNCE_ADMIN_LOGIN, MAP_VOTING, KICK_VOTING, PUBLIC_CHAT, SPECTATORS_ONLY_CHAT_OTHER_SPECTATORS, VOIP, CHAT_LOGGING, MAP_VOTING_TIME, KICK_PERCENTAGE)
VALUES(1000, 'Default', 1, 1000, 1000, 1000, 1000, 1006, 'Killing Floor 2 Server', 8080, 7777, 27015, true, false, true, true, false, true, true, true, true, false, true, false, 60, 0.66);
